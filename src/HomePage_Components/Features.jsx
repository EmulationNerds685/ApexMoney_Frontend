...
// --- ICONS (No changes needed, these are great) ---
...
const FeatureCard = ({ icon, title, description, visualContent }) => (
  <div className="bg-white rounded-2xl p-8 flex flex-col items-start h-full transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ring-1 ring-gray-200">
    <div className="bg-purple-100 text-purple-600 p-3 rounded-xl mb-6">
      {icon}
    </div>
...
// --- Data for the features, making the component easier to manage ---
const featuresData = [
  {
    ...
    visualContent: (
      <div className="bg-gray-100 rounded-lg p-4 space-y-2">
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium text-gray-700">☕️ Coffee Shop</span>
          <span className="text-sm font-semibold text-red-500">-$5.50</span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium text-gray-700"> groceries</span>
          <span className="text-sm font-semibold text-red-500">-$72.30</span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium text-gray-700">Salary</span>
          <span className="text-sm font-semibold text-green-500">+$2,500.00</span>
        </div>
      </div>
    ),
  },
    ...
    visualContent: (
      <div className="bg-gray-100 rounded-lg p-4">
        <div className="flex justify-between items-center mb-1">
          <span className="text-sm font-medium text-gray-700">Food Budget</span>
          <span className="text-sm font-semibold text-gray-500">$280 / $400</span>
        </div>
  ...
  },
  {
    ...
    visualContent: (
      <div className="bg-gray-100 rounded-lg p-4 space-y-2">
        <div className="flex justify-between items-center p-2 rounded-md hover:bg-gray-200 transition">
          <span className="text-sm font-medium text-gray-700">Checking Account</span>
          <span className="text-sm font-mono text-gray-800">$4,128.55</span>
        </div>
        <div className="flex justify-between items-center p-2 rounded-md hover:bg-gray-200 transition">
          <span className="text-sm font-medium text-gray-700">Savings Account</span>
          <span className="text-sm font-mono text-gray-800">$15,600.10</span>
        </div>
      </div>
    ),
  },
    ...
    <section className="bg-white py-20 sm:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          <button className="bg-purple-600 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 hover:bg-purple-700 hover:scale-105 shadow-lg shadow-purple-200">
