    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <dt className="mt-4 font-semibold text-gray-900 text-lg">Save Time on Manual Calculations</dt>
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <dt className="mt-4 font-semibold text-gray-900 text-lg">Get Real-Time Financial Insights</dt>
              <dd className="mt-2 leading-7 text-gray-600">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <dt className="mt-4 font-semibold text-gray-900 text-lg">Stay on Top of Budgets</dt>
              <dd className="mt-2 leading-7 text-gray-600">
        ...
        <div className="mt-20 flex flex-col items-center gap-y-4">
            ...
            <button className="bg-slate-100 text-slate-600 font-semibold py-3 px-8 rounded-full transition-all duration-300 hover:bg-slate-200 ring-1 ring-slate-200">
